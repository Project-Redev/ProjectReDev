...
import net.roadkill.redev.ReDevEntities;
    ...
    public void onLand(Level level, BlockPos pos, BlockState state, BlockState oldState, FallingBlockEntity fallingBlock)
    {
        if (fallingBlock.time > 10)
        {
            ...
            for (int i = 0; i < thornCount; i++) {
                // TODO fix that
                DurianThornEntity thorn = new DurianThornEntity((EntityType<? extends AbstractArrow>) ReDevEntities.DURIAN_THORN.get(), level);
